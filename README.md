...
graph TD
  ...
  A4 --> A5[Generate Embeddings and Image Keys]
  A5 --> A6[Store in PostgreSQL and pgvector]

  U1[User Chat UI - React] --> U2[Enter Query]
  U2 --> U3[NodeJS Server - Auth and API]
  U3 --> U4[GCN - Get Similar PDFs]
  U4 --> U5[Vector Search - Get Content and Pages]

  U3 --> O1[Online Context Wrapper - Python]
  O1 --> O2[Generate Search Query]
  O2 --> O3[Scrape Top 5 Links using Playwright]
  O3 --> O4[Extract Text Images and Videos]

  U5 --> F1[AI Middleware - Combine Contexts]
  O4 --> F1
  U2 --> F1

  F1 --> R1[Generate Final Answer and Metadata]
